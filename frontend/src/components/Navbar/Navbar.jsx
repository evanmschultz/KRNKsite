            ...
            <div className={styles.header}>
                ...
                <div className={styles.menu}>
                    <Accordion style={{border: "1px solid black"}}>
                        ...
                        ><h3>Account</h3></AccordionSummary>
                        <AccordionDetails>
                            <div>
                                <Button component={Link} to={"/interests"}>Interests</Button>
                            </div>
                            <div>
                                <Button component={Link} to={"/edit/" + userId}>Settings</Button>
                            </div>
                            <div>
                                <Button component={Link} to={"/"} onClick={logoutUser}>Logout</Button>
                            </div>
                        </AccordionDetails>
                    </Accordion>
                </div>
